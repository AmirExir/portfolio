...
tk.Label(root, text="Voltage Level (kV)").grid(row=7, column=0, sticky="w", padx=5)
kV_var = tk.StringVar()
kV_menu = ttk.Combobox(root, textvariable=kV_var, values=[])
kV_menu.grid(row=7, column=1, padx=5, pady=2)
kV_var.trace('w', update_conductors)

tk.Label(root, text="Conductors Per Phase").grid(row=8, column=0, sticky="w", padx=5)
...
Conductors_Per_Phase_menu.grid(row=8, column=1, padx=5, pady=2)
Conductors_Per_Phase_var.trace('w', update_conductors)

tk.Label(root, text="Conductor Type").grid(row=9, column=0, sticky="w", padx=5)
conductor_var = tk.StringVar()
conductor_menu = ttk.Combobox(root, textvariable=conductor_var, values=[])
conductor_menu.grid(row=9, column=1, padx=5, pady=2)
...
btn_generate.grid(row=10, column=0, columnspan=2, pady=15)
